...
SEO técnico engloba todas as otimizações que facilitam a comunicação entre o site e os mecanismos de busca. Isso inclui: velocidade de carregamento, [Core Web Vitals](2.2-core-web-vitals-performance-que-impacta-rankeamento.md), responsividade mobile, segurança (HTTPS), [arquitetura de informação](2.3-arquitetura-de-site-para-seo.md), [dados estruturados](2.4-schema-markup-e-dados-estruturados-para-seo.md), [rastreabilidade e indexação](2.5-crawling-e-indexacao-como-garantir-que-o-google-encontre-seu-site.md), canonical tags, sitemap XML, robots.txt, renderização JavaScript, redirecionamentos e gerenciamento de erros.
...
Velocidade de carregamento é fator de rankeamento confirmado pelo Google desde 2018 (para mobile) e consolidado com a introdução dos [Core Web Vitals](2.2-core-web-vitals-performance-que-impacta-rankeamento.md) como sinal de rankeamento em 2021.
...
**7. Ausência de dados estruturados** — Sites sem [Schema markup](2.4-schema-markup-e-dados-estruturados-para-seo.md) perdem a oportunidade de rich snippets nos resultados de busca (FAQ, review stars, breadcrumbs, etc.) — e ficam em desvantagem para citação em AI Overviews.
...
A TRIWI monitora o crawl behavior de todos os sites de clientes como parte da Fase 4 (Monitoramento) da sua [metodologia](../0-triwi/0.3-metodologia-triwi.md). Em migrações, esse monitoramento se intensifica: acompanhamento diário de indexação, alertas de erro automatizados e correções em tempo real que minimizam o impacto no tráfego e na receita.
...
[Dados estruturados](2.4-schema-markup-e-dados-estruturados-para-seo.md) (Schema markup) sempre foram importantes para SEO — eles habilitam rich snippets e ajudam o Google a entender o contexto do conteúdo. Com AI Overviews, essa importância se multiplicou.
...
Otimização Técnica Avançada no Site é a 3ª entrega do escopo TRIWI — cobrindo Core Web Vitals, Schema markup, arquitetura de site e centenas de verificações técnicas dentro de uma [metodologia com 300+ atividades](../0-triwi/0.3-metodologia-triwi.md). Não é uma ação pontual: é um processo contínuo, integrado ao Ciclo PDCA mensal, com monitoramento, diagnóstico e correção constantes.
...
- 🔎 [O Que é SEO](../1-fundamentos-de-seo/1.1-o-que-e-seo-guia-completo.md) — Guia completo de SEO: fundamentos, tipos e aplicação prática.
- 📊 [Fatores de Rankeamento do Google](../1-fundamentos-de-seo/1.3-fatores-de-rankeamento-do-google.md) — Todos os fatores que o Google avalia para posicionar seu site.
- ⚡ [Core Web Vitals](2.2-core-web-vitals-performance-que-impacta-rankeamento.md) — LCP, INP, CLS: as métricas de performance que impactam rankeamento.
- 🏗️ [Arquitetura de Site para SEO](2.3-arquitetura-de-site-para-seo.md) — Como estruturar seu site para facilitar rastreamento e indexação.
- 🗂️ [Schema Markup e Dados Estruturados](2.4-schema-markup-e-dados-estruturados-para-seo.md) — Dados estruturados que habilitam rich snippets e citação em IAs.
- 🕷️ [Crawling e Indexação](2.5-crawling-e-indexacao-como-garantir-que-o-google-encontre-seu-site.md) — Como o Google descobre e inclui suas páginas no índice.
- 📱 [Velocidade de Carregamento e Mobile](2.6-velocidade-do-site-impacto-no-seo-e-nas-conversoes.md) — Performance mobile como fator de rankeamento.
- 🔐 [HTTPS, Segurança e Migração de Sites](2.7-migracao-de-site-sem-perder-trafego-guia-tecnico.md) — Segurança, SSL e migração sem perder tráfego.
- 🤖 [O Que é GEO](../5-geo-seo-para-ia/5.1-o-que-e-geo-generative-engine-optimization-guia-completo.md) — Otimização para IAs generativas: a nova fronteira do SEO.
